...
// [0, 1]
#define DARKEN_MIX 0.6

// How far in the vignette spreads
// x \in R : x >= 0
#define VIGNETTE_SPREAD 0.09
...
// [0, 1]
#define NOISE_CONTENT_STRENGTH 0.2
