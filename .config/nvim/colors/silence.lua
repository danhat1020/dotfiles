...
hi('DiagnosticError',          { fg='#c04040',    bg='none'      })
hi('DiagnosticWarn',           { fg='#c0a040',    bg='none'      })
hi('DiagnosticInfo',           { fg='#40b0c0',    bg='none'      })
hi('DiagnosticHint',           { fg='#80a0c0',    bg='none'      })
hi('DiagnosticUnderlineError', {                  bg='none',     underline = true, sp = '#c04040' })
hi('DiagnosticUnderlineWarn',  {                  bg='none',     underline = true, sp = '#c0a040' })
hi('DiagnosticUnderlineInfo',  {                  bg='none',     underline = true, sp = '#40b0c0' })
hi('DiagnosticUnderlineHint',  {                  bg='none',     underline = true, sp = '#80a0c0' })
