...
-- Extra brightness
hl.bind("SUPER + bracketleft",   hl.dsp.exec_cmd("busctl --user -- call rs.wl-gammarelay / rs.wl.gammarelay UpdateBrightness d -0.05"),   { locked = true, repeating = true })
hl.bind("SUPER + bracketright",  hl.dsp.exec_cmd("busctl --user -- call rs.wl-gammarelay / rs.wl.gammarelay UpdateBrightness d +0.05"),   { locked = true, repeating = true })
hl.bind("SUPER + P",             hl.dsp.exec_cmd("busctl --user -- set-property rs.wl-gammarelay / rs.wl.gammarelay Brightness d 1.0"),   { locked = true })
-- Screen temperature
hl.bind("SUPER + Up",            hl.dsp.exec_cmd("busctl --user -- call rs.wl-gammarelay / rs.wl.gammarelay UpdateTemperature n +500"),   { locked = true, repeating = true })
hl.bind("SUPER + Down",          hl.dsp.exec_cmd("busctl --user -- call rs.wl-gammarelay / rs.wl.gammarelay UpdateTemperature n -500"),   { locked = true, repeating = true })
hl.bind("SUPER + SHIFT + P",     hl.dsp.exec_cmd("busctl --user -- set-property rs.wl-gammarelay / rs.wl.gammarelay Temperature q 6500"), { locked = true })
-- Requires playerctl
