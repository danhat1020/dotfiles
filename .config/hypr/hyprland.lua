...
hl.animation({ leaf = "windowsOut", enabled = true, speed = 4.0, bezier = "smoothInOut", style = "popin 96%" })
...
hl.animation({ leaf = "workspaces", enabled = true, speed = 4.0, bezier = "stylish", style = "slidefade 16%" })
...
hl.bind("SUPER + G", function()
  hl.dsp.exec_cmd("pkill wl-gammarelay")
  hl.dsp.exec_cmd("wl-gammarelay &")
end)
